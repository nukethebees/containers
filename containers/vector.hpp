...
class vector {
  public:
    ...
    // Iterators
    auto begin(this vector& self) -> iterator { return iterator(self.data_); }
    auto cbegin(this vector const& self) -> const_iterator { return const_iterator(self.data_); }
    auto end(this vector& self) -> iterator { return iterator(self.data_ + self.size_); }
    auto cend(this vector const& self) -> const_iterator { return const_iterator(self.data_ + self.size_); }
