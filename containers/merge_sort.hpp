...
void merge_sort(Iterator begin, Iterator end) {
    ...
    static constexpr auto split_vector{[](auto it, auto end) {
        ...
        auto const mid{n / 2};
        auto const it_mid{(it + static_cast<IterDiff>(mid))};
    ...
    static constexpr auto merge{[](auto it, auto itl, auto lend, auto itr, auto rend) {
    ...
    merge(begin, sv.left.begin(), sv.left.end(), sv.right.begin(), sv.right.end());
}
}
